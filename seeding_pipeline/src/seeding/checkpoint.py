...
class ProgressCheckpoint(BaseProgressCheckpoint):
    ...
    # Note: VTT file tracking methods removed in favor of Neo4j-based tracking
    # The following methods have been deprecated:
    # - mark_vtt_processed
    # - is_vtt_processed
    # - get_processed_vtt_files
    # - mark_vtt_moved_to_processed
    # - clear_vtt_checkpoint
    # Use EpisodeTracker from src.tracking instead
