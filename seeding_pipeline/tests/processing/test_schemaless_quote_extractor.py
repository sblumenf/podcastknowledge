"""Tests for schemaless quote extractor."""
...
class TestSchemalessQuoteExtractor:
    """Test suite for SchemalessQuoteExtractor."""

    @pytest.fixture
    def extractor(self):
        """Create quote extractor instance."""
        return SchemalessQuoteExtractor()
